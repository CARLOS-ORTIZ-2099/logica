...
(() => {
  ...
  const ar = [
    1,
    2,
    [3, 4, [5, 6, [7, { name: "carlos", age: 20 }], 8]],
    9,
    [10],
    11,
  ];
...
(() => {
  ...
  function pyramid(n, level, body, space) {
    if (level <= n) {
      ...
      text = text
        .padStart(space + text.length, " ")
        .padEnd(space + text.length + space, " ");
      console.log(`${text}`);
...
(() => {
  ...
  const obj = {
    ...
    address: {
      city: "city center",
      loc: { alt: 100, lat: 200, zip: { loc: 10000 } },
    },
    friends: [
      {
        name: "mateo",
        addres: {
          city: "city pineaple",
          loc: { alt: 600, lat: 700, zip: { loc: 800 } },
        },
      },
      {
        name: "maria",
        addres: {
          city: "city apple",
          loc: { alt: 900, lat: 1000, zip: { loc: 1001 } },
        },
      },
    ],
  };
